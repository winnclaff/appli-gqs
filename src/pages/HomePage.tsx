...
import { fetchGqsReferentiel, fetchThemes } from '../lib/api';
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const t = await fetchThemes(ref.id);
  ...
  return (
    <section>
      ...
      <p className="text-slate-700 mb-6">
        Fiches mémo et quiz basés sur le référentiel GQS (arrêté du 30 juin 2017, DGSCGC).
      </p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-sm text-slate-600">Par thème ou mélangé, 5 ou 10 questions</div>
            </div>
          </div>
      ...
      <h2 className="text-lg font-semibold mb-3">Thèmes</h2>
            ...
            return (
              <li key={theme.id}>
                ...
                >
                  ...
                  <ChevronRight className="h-5 w-5 text-slate-400 shrink-0 mt-1" aria-hidden />
                </Link>
              </li>
            );
          })}
