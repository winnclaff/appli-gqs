-- ============================================================
-- Seed v2 — À exécuter APRÈS soins-urgence-schema-v2.sql
-- Contient : 14 fiches mémo GQS remappées + 60 questions Notion
-- (thèmes, référentiels, quiz mixte déjà en place dans schema-v2)
-- ============================================================

-- ============================================================
-- MEMO CARDS (14 fiches, level = grand_public)
-- Rattachées aux nouveaux thèmes v2.
-- ============================================================

insert into memo_cards (theme_id, title, action_steps, source_ref, source_name, source_url, levels, sort_order) values

-- Protection / EPI
('a0000000-0000-0000-0000-000000000102', 'Protection',
...
('a0000000-0000-0000-0000-000000000103', 'Hémorragies externes',
...
-- Compression directe
('a0000000-0000-0000-0000-000000000103', 'Compression directe',
...
'https://www.interieur.gouv.fr/Le-ministere/Securite-civile/Documentation-technique/Secourisme-et-associations/Les-recommandations-et-les-referentiels',
ARRAY['grand_public'], 2),

-- Garrot
('a0000000-0000-0000-0000-000000000103', 'Garrot',
...
'https://www.interieur.gouv.fr/Le-ministere/Securite-civile/Documentation-technique/Secourisme-et-associations/Les-recommandations-et-les-referentiels',
ARRAY['grand_public'], 3),

-- Perte de connaissance
('a0000000-0000-0000-0000-000000000105', 'Perte de connaissance',
...
('a0000000-0000-0000-0000-000000000105', 'Libération des voies aériennes',
...
('a0000000-0000-0000-0000-000000000105', 'Position latérale de sécurité',
...
-- Arrêt cardiaque
('a0000000-0000-0000-0000-000000000106', 'Arrêt cardiaque',
...
('a0000000-0000-0000-0000-000000000106', 'Compressions thoraciques',
...
-- Insufflations
('a0000000-0000-0000-0000-000000000106', 'Insufflations',
...
-- Défibrillation
('a0000000-0000-0000-0000-000000000106', 'Défibrillation',
...
'https://www.interieur.gouv.fr/Le-ministere/Securite-civile/Documentation-technique/Secourisme-et-associations/Les-recommandations-et-les-referentiels',
ARRAY['grand_public'], 4),

-- DAE (fiche explicative)
('a0000000-0000-0000-0000-000000000106', 'Défibrillateur automatisé externe (DAE)',
...
'[02AC02 / 12-2022] GQS DAE', 'GQS - DGSCGC, éd. décembre 2023',
'https://www.interieur.gouv.fr/Le-ministere/Securite-civile/Documentation-technique/Secourisme-et-associations/Les-recommandations-et-les-referentiels',
ARRAY['grand_public'], 5),

-- Plaies
('a0000000-0000-0000-0000-000000000107', 'Plaies',
...
-- ============================================================
-- QUESTIONS (60, provenant de la base Notion "Quiz Secourisme")
-- N° = numéro d'origine dans Notion (colonne "N°")
-- levels = niveau(x) visé(s) ; referentiel_codes = référentiel(s) source
-- ============================================================
...
('a0000000-0000-0000-0000-000000000101', 4,
 'Quels sont les numéros d''urgence enseignés dans le triptyque de référence GQS depuis l''édition 2026 ?',
 '["15, 17, 18","18, 15, 112","18, 15, 114","112, 15, 114"]',
 1, 'Le 114 (SMS pour personnes sourdes et malentendantes) a été retiré de la liste des numéros enseignés en GQS dans l''édition juillet 2026, au profit du triptyque 18/15/112.',
...
('a0000000-0000-0000-0000-000000000110', 8,
 'Le film alimentaire fait-il toujours partie des moyens de protection recommandés pour une brûlure grave en 2026 ?',
 '["Oui, il reste recommandé en première intention","Non, il a été retiré des moyens de protection recommandés","Oui, mais uniquement pour les brûlures du visage","Le film alimentaire n''a jamais été mentionné dans les recommandations"]',
 1, 'Point de vigilance ajouté : surveiller les jeunes enfants bénéficiant d''un refroidissement actif à l''eau courante pour détecter un refroidissement excessif du corps.',
 'RTN PSE1/PSE2 (DGSCGC, éd. 2026)', ARRAY['pse'], ARRAY['pse']),
...
('a0000000-0000-0000-0000-000000000113', 12,
 ...
 '["Le module \"urgences vitales\"","Le module \"urgences potentielles\"","Le module \"risques collectifs\"","Aucun module ne traite ce sujet"]',
 1, 'Ce module comprend la connaissance et l''utilisation du matériel de prise en charge initiale : DEA, oxygénothérapie, chariot/sac d''urgence.',
 'AFGSU (Arrêté 30/12/2014 modifié 01/07/2019)', ARRAY['afgsu'], ARRAY['afgsu']),
...
('a0000000-0000-0000-0000-000000000106', 15,
 'Quel est le rôle du coach introduit par la RTN 2026 en cas d''arrêt cardiaque ?',
...
('a0000000-0000-0000-0000-000000000108', 23,
 ...
 '["50 ans et plus","60 ans et plus, sans autre critère","65 ans et plus, avec antécédents à risque","75 ans et plus, systématiquement"]',
 2, 'S''ajoute aux critères classiques : réponses non fiables, signes d''atteinte rachidienne/médullaire, accident à haut risque.',
 'RTN PSE1/PSE2 (DGSCGC, éd. 2026)', ARRAY['pse'], ARRAY['pse']),
...
('a0000000-0000-0000-0000-000000000103', 30,
 ...
 2, 'Les garrots élastiques de prélèvement sanguin sont explicitement exclus.',
 'RTN GQS + PSC + PSE (DGSCGC, éd. 2026)', ARRAY['grand_public','psc','pse'], ARRAY['gqs','psc','pse']),
...
('a0000000-0000-0000-0000-000000000113', 33,
 ...
 '["Protection et alerte uniquement","Malaise, traumatismes, brûlures, hygiène (+ chariot d''urgence et oxygénothérapie en AFGSU2)","Arrêt cardio-respiratoire et défibrillation","Risques NRBC-E exclusivement"]',
 1, 'L''AFGSU2 approfondit ce module avec du matériel spécifique aux professionnels de santé.',
 'AFGSU (Arrêté 30/12/2014 modifié 01/07/2019)', ARRAY['afgsu'], ARRAY['afgsu']),
...
('a0000000-0000-0000-0000-000000000111', 37,
 'Que couvre le module "risques collectifs et situations sanitaires exceptionnelles", réservé à l''AFGSU2 ?',
 '["Hémorragies et plaies simples","ORSAN, ORSEC, damage control, risques NRBC-E, alertes, prise en charge médico-psychologique","Uniquement la gestion du chariot d''urgence","Les gestes de premiers secours de base, identiques au module 1"]',
 1, 'Ce module n''existe pas en AFGSU1, réservé aux professionnels de santé de l''AFGSU2.',
